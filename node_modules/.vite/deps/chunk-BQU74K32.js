      ...
      if (_selected) {
        if (scope.mode === "translate") {
          if (_raycaster.ray.intersectPlane(_plane, _intersection)) {
            ...
            _selected.position.divideScalar(1).floor().multiplyScalar(1).addScalar(0.5);
            _selected.position.y = 0;
            if (_selected.position.x < -4.5)
              _selected.position.x = -4.5;
            if (_selected.position.x > 4.5)
              _selected.position.x = 4.5;
            if (_selected.position.z < -4.5)
              _selected.position.x = -4.5;
            if (_selected.position.z < 4.5)
              _selected.position.x = 4.5;
          }
...
//# sourceMappingURL=chunk-BQU74K32.js.map
